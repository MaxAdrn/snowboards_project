...
use App\Repository\CambreRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=CambreRepository::class)
 */
class Cambre
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Snowboards::class, mappedBy="cambre")
     */
    private $snowboards;
    ...
    public function removeSnowboard(Snowboards $snowboard): self
    {
        if ($this->snowboards->removeElement($snowboard)) {
            ...
            if ($snowboard->getCambre() === $this) {
                $snowboard->setCambre(null);
            }
        }
